(() => {
  function initializeSheetSidebarActions() {
  ...
  initializeSheetSidebarActions();
})();

(() => {
  function initializeSheetCsCard() {
    const root = document.documentElement;
    if (root.dataset.tnxCsCardInitialized === '1') return;
    root.dataset.tnxCsCardInitialized = '1';
