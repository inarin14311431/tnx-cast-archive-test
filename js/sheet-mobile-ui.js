...
import "./sheet-mobile-import.js?v=20260818-2";
import "./sheet-mobile-profile.js?v=20260818-3";

const $=selector=>document.querySelector(selector);
function ensureCommonStyles(){const base=document.querySelector('link[href*="/sheet-mobile.css"],link[href^="./css-next/pages/sheet-mobile.css"]');if(base)base.href="./css-next/pages/sheet-mobile.css?v=5";const styles=[["mobile-theme","./css-next/pages/sheet-mobile-theme.css?v=1"],["mobile-ui","./css-next/pages/sheet-mobile-ui.css?v=3"],["mobile-profile-current","./css-next/pages/sheet-mobile-profile.css?v=11"],["mobile-ability-current","./css-next/pages/sheet-mobile-ability.css?v=4"],["mobile-skills","./css-next/pages/sheet-mobile-skills.css?v=3"],["mobile-combo","./css-next/pages/sheet-mobile-combos.css?v=5"],["mobile-snapshots","./css-next/pages/sheet-mobile-snapshots.css?v=2"],["mobile-import","./css-next/pages/sheet-mobile-import.css?v=2"]];for(const[key,href]of styles){const current=document.querySelector(`link[data-${key}-style]`);if(current){if(current.getAttribute("href")!==href)current.href=href;continue;}const link=document.createElement("link");link.rel="stylesheet";link.href=href;link.setAttribute(`data-${key}-style`,"1");document.head.append(link);}}
