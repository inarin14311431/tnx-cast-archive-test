...
(()=>{
  ...
  import('./help-ui.js?v=2026091101').catch(error=>console.error('sheet help failed to load',error));
  ...
  async function fetchSource(key){
    const {requestCharacterSheetSource}=await import('./character-sheet-source.js?v=2026091101');
