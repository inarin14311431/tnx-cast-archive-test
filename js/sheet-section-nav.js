...
function initializeSheetSectionNav() {
  ...
  import("./help-ui.js?v=2026091101").catch(error => console.warn("Editor help could not be initialized.", error));
  import("./sheet-save-diagnostics.js?v=2026091101").catch(error => console.warn("Save diagnostics could not be initialized.", error));
}
