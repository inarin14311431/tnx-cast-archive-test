...
function init(){patch();const root=$("#mobile-profile-summary-grid");if(root)new MutationObserver(patch).observe(root,{childList:true,subtree:true});$("#mobile-profile-form")?.addEventListener("input",patch);}
