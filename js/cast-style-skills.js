...
import "./skill-display-enhancements.js?v=2";
...
function parseDetail(value) {
  ...
  if (text.startsWith(PREFIX)) { try { return { ...empty, ...JSON.parse(text.slice(PREFIX.length).trim()) }; } catch {} }
...
function findSection() {
  return document.querySelector("#style-skill-panel .skill-section--style, #style-skill-panel .skill-section, #skills-container .skill-section--style");
}
