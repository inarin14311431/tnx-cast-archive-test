...
test("ACT showcase publishing is a critical module loaded before optional enhancements", () => {
  const publishIndex = loader.indexOf("showcase-dynamic-publish.js?v=6");
...
test("ACT showcase generator refreshes both outer and nested cache boundaries", () => {
  assert.match(html, /showcase-generator-loader\.js\?v=22/);
  assert.doesNotMatch(html, /showcase-generator-loader\.js\?v=(?:18|19|20|21)/);
  assert.match(loader, /showcase-generator-v3\.js\?v=8/);
  assert.match(loader, /showcase-dynamic-publish\.js\?v=6/);
